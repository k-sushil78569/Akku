...
const MELODY = [
  ...
  ['C5', 0.5], ['C5', 0.5], ['B4', 0.75], ['A4', 0.5], ['A4', 0.5], ['G4', 0.75],
  ['F4', 0.5], ['A4', 0.5], ['G4', 0.5], ['F4', 0.5], ['E4', 1.5],
  // Ek hazaaron mein meri behna hai
  ['G4', 0.5], ['C5', 0.5], ['C5', 0.5], ['C5', 0.5], ['B4', 0.75], 
  ['A4', 0.5], ['A4', 0.5], ['G4', 0.25], ['F4', 0.25], ['G4', 1.5],
  // Sari umar humein sang rehna hai
  ['G4', 0.5], ['G4', 0.5], ['A4', 0.5], ['A4', 0.5], ['B4', 0.5], ['B4', 0.5],
  ['C5', 0.75], ['D5', 0.5], ['D5', 0.5], ['E5', 0.5], ['D5', 0.5], ['C5', 1.5]
];
